...
public class Ex6_MoveTowardsSPhere : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 distance = sphere.transform.position - cube.transform.position;
        distance = distance.normalized;
        cube.transform.Translate(speed * distance.x, 0, speed * distance.z);
